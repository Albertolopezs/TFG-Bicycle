...
var initGUI = function() {
    ...
    var addChoiceInput = function(param, obj) {
        ...
        var template = [
            "<div><p><label for='" + domID + "' class='label label-primary'>" + obj.name + "</label></p>",
            "<div class='dropdown'>",
...
ws.onmessage = function(message) {
    ...
    switch (msg["type"]) {
        ...
        case "end":
            ...
            break;
        case "model_params":
            console.log("model_params",msg["params"]);
            model_params = msg["params"];
            initGUI();
            break;
        case "get_situation":
            self.LeafletVisualization.update_data(msg['data']);
            self.LeafletVisualization.set_hour();
            self.LeafletVisualization.clear_station_markers();
            self.LeafletVisualization.set_station_markers();
            self.LeafletVisualization.clear_bike_markers();
            self.LeafletVisualization.set_bike_markers();
            self.LeafletVisualization.clear_truck_markers();
            self.LeafletVisualization.set_truck_markers();
        default:
            // There shouldn't be any other message
            console.log("Unexpected message.",msg['type']);
    }
};
